...
public class Daftar extends javax.swing.JFrame {
    ...
    private void tabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelMouseClicked
       ...
       try{
        ...
        String tblklik = (tabel.getModel().getValueAt(row, 0).toString());
        String sql = "SELECT * FROM login WHERE id_user='"+tblklik+"'";
        ps = conn.prepareStatement(sql);
        rs = ps.executeQuery();
        if(rs.next()){
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        try{
            ...
            String tblklik = (tabel.getModel().getValueAt(baris, 0).toString());
            String sql = "UPDATE Login SET username=?, password=?, nama=?, telepon=?, alamat=?, status=? WHERE id_user="+tblklik;
            ps = conn.prepareStatement(sql);
